...
test('1.5 ticket keeps workflow comments internal notes SLA history and attachments readable',()=>{
  for(const token of ['jsm-ticket-header','ticket-layout','ticket-sidebar','comment.internal','sla-block','sd14-history','r112-attachments'])assert.ok(css.includes(token),`missing ticket style ${token}`);
