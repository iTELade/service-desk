...
test('Settings Center asset versions are aligned with 1.2.0', () => {
  assert.match(center, /const SETTINGS_VERSION='1\.2\.0';/);
  assert.match(nav, /const SETTINGS_NAV_VERSION = '1\.2\.0';/);
});
