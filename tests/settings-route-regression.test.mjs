...
test('Settings Center asset versions are aligned with 1.0.8', () => {
  assert.match(center, /const SETTINGS_VERSION='1\.0\.8';/);
  assert.match(nav, /const SETTINGS_NAV_VERSION = '1\.0\.8';/);
});
