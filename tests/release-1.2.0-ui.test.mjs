...
test("1.3.1 canonical UI assets are wired",()=>{for(const f of ["release-1.2.0.css","release-1.2.0-nav.css","release-1.2.0.js"]){assert.ok(i.includes("/"+f+"?v=1.3.1"));assert.ok(s.includes("['/"+f));}});
